...
--local FluidBoxAmountValue = SS["FluidBoxAmountValueX"].value --For test´s
...
data:extend({
	{
		...
		fluid_box = {
			...
			volume = SS["Tier-1"].value * Multiplier,
			base_area = 1,
			height = 2,
			base_level = -1,
			pipe_connections = {},
    ...
    },
	{
		...
		selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
		fluid_box = {
			volume = SS["Tier-2"].value * Multiplier,
			base_area = 1,
			height = 2,
			base_level = -1,
			pipe_connections = {},
    ...
    },
	{
        ...
        selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
        fluid_box = {
            volume = SS["Tier-3"].value * Multiplier,
            base_area = 1,
            height = 2,
            base_level = -1,
            pipe_connections = {},
    ...
    },
	{
        ...
        selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
        fluid_box = {
            volume = SS["Tier-4"].value * Multiplier,
            base_area = 1,
            height = 2,
            base_level = -1,
            pipe_connections = {},
    ...
    },
	{
        ...
        selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
        fluid_box = {
            volume = SS["Tier-5"].value * Multiplier,
            base_area = 1,
            height = 2,
            base_level = -1,
            pipe_connections = {},
